...
class CasRenderer
{
    ...
    public function __construct(CasRendererEngine $engine)
    {
        $this->engine = $engine;
    }
    ...
    public function setTheme($view, $themes)
    {
     ...
     * {@inheritdoc}
     */
    public function searchAndRenderBlock(CasView $view, $blockNameSuffix, array $variables = array())
    {
